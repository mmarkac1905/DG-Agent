...
def validate_model_semantics(
    ...
    system_prompt = (
        ...
        "2. FILTER — does the SQL reflect the exclusions the term says to apply?\n"
        "   - Look for WHERE clauses / NOT EXISTS / anti-joins that match "
        "each exclusion the term mentions.\n"
        "   - Flag only exclusions that the term STATES but the SQL does NOT "
        "implement. Do not invent exclusions.\n\n"
